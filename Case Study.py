...
# -*- coding: utf-8 -*-
"""
Created on Thu May  4 21:25:40 2023

Author: Marius Mickunas

Title: Bringing it all together - Case Study
"""
#%%
...
bank = pd.read_csv('https://assets.datacamp.com/production/repositories/464/datasets/2175fef4b3691db03449bbc7ddffb740319c1131/world_ind_pop_data.csv', index_col = 0)

bank.to_csv("ind_pop.csv")
...
Complete the for loop so that it iterates 1000 times to perform the loop body and process only the first 
1000 rows of data of the file.
'''
...
Using zip(), zip together the 'Total Population' and 'Urban population (% of total)' columns of df_pop_ceb.
Assign the resulting zip object to pops.
'''
# Initialize reader object: urb_pop_reader
urb_pop_reader = pd.read_csv('ind_pop.csv', chunksize = 1000)
...
#%%
'''
Define the function plot_pop() that has two arguments: first is filename for the file to process and second is country_code 
for the country to be processed in the dataset.

Call plot_pop() to process the data for country code 'CEB' in the file 'ind_pop.csv'.

Call plot_pop() to process the data for country code 'ARB' in the file 'ind_pop.csv'.
'''
# Define plot_pop()
...
plot_pop('ind_pop.csv', 'CEB')

# Call plot_pop for country code 'ARB'
plot_pop('ind_pop.csv', 'ARB')
#%%
