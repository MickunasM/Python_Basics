...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 25 23:38:56 2023

Author: Marius Mickunas

Title: Lambda functions and error-handling
"""
#%%
...
In the body of the if statement, add a raise statement that raises a ValueError with message 
'echo must be greater than or equal to 0' when the value supplied by the user to echo is less than 0.
'''
# Define shout_echo
def shout_echo(word1, echo=1):
    """Concatenate echo copies of word1 and three
...
Print result1. This has been done for you, so hit 'Submit Answer' to check out the result. In the next exercise, you'll see that it
