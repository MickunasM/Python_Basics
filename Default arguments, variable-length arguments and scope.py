...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 25 22:20:57 2023

Author: Marius Mickunas

Title: Default arguments, variable-length arguments and scope
"""
#%%
...
#%%
'''
In this exercise, you will complete the definition of the inner function inner_echo() and then call echo() 
...
#%%
'''
In this exercise, you will use the keyword nonlocal within a nested function to alter the value of a variable defined in the 
enclosing scope.
'''
...
#%%
'''
Practice by writing a function that uses a default argument and then calling the function a couple of times.
'''
...
a default argument echo with default value 1 and a default argument intense with default value False, in that order.
...
#%%
'''
Use **kwargs in this exercise to define a function that accepts a variable number of keyword arguments. 
...
'''
Complete the function header by supplying the parameter for a DataFrame df and the parameter col_name 
with a default value of 'lang' for the DataFrame column name.
...
#%%
'''
You're now going to generalize this function one step further by allowing the user to pass it a flexible argument, 
