...
# -*- coding: utf-8 -*-
"""
Created on Wed May  3 21:13:57 2023
...
#%%
'''
In the inner list comprehension - that is, the output expression of the nested list comprehension - create a list of values 
...
create a list of values from 0 to 4. Use row as the iterator variable; note that you won't be needing this variable to 
