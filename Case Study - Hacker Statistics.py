...
# -*- coding: utf-8 -*-
"""
Created on Tue Apr 25 14:05:18 2023

Author: Marius Mickunas

Title: Case Study: Hacker Statistics
"""
#%%
'''
...
#%%
'''
As Hugo explained in the video you can just as well use randint(), also a function of the random package, 
to generate integers randomly. The following call generates the integer 4, 5, 6 or 7 randomly. 8 is not included.
'''
...
'''
ends_over_60 = (ends >= 60).sum()
print(ends_over_60)

odds = ends_over_60 / 500
print(odds)
